...
Npc_Girl::Npc_Girl()
{
	...
	movePoint.push_back(Vector2(1800, 1050));
	movePoint.push_back(Vector2(2026, 1050));
	movePoint.push_back(Vector2(1800, 1050));
...
void Npc_Girl::Update()
{
	...
	if (_index == 0) _frameY = 2;
	if (_index == 1) _frameY = 0;
	if (_index == 2) _frameY = 1;
	if (_index == 3)_frameY = 3;
...
void Npc_Girl::Render()
{
	...
	_imgGirl->SetSize(Vector2(60, 60));
