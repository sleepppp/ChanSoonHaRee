...
*******************************************************/
bool TextWriter::Open(string filePath)
{
	//fopen_s : c스타일의 파일입출력 
	//FILE*, 파일경로,읽는 방식
...
@@ string str : 저장할 문자열
*******************************************************/
void TextWriter::String(string str)
{
...
@@ string filePath : 파일 경로 
*******************************************************/
bool TextReader::Open(string filePath)
{
